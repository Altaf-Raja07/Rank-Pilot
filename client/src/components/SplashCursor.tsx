  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      let gl: WebGLRenderingContext | WebGL2RenderingContext | null =
        canvas.getContext("webgl2", params as WebGLContextAttributes) as WebGL2RenderingContext | null;
      const isWebGL2 = !!gl;
      if (!isWebGL2)
        gl =
          (canvas.getContext("webgl", params as WebGLContextAttributes) as WebGLRenderingContext) ||
          (canvas.getContext("experimental-webgl", params as WebGLContextAttributes) as WebGLRenderingContext);
    ...
    function updatePointerMoveData(pointer: PointerState, posX: number, posY: number, color: { r: number; g: number; b: number }) {
      pointer.prevTexcoordX = pointer.texcoordX;
      pointer.prevTexcoordY = pointer.texcoordY;
      pointer.texcoordX = posX / canvas!.width;
      pointer.texcoordY = 1.0 - posY / canvas!.height;
